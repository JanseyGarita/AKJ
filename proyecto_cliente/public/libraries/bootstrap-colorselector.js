...
(function ($) {
    ...
    ColorSelector.prototype = {
        ...
        _init: function () {
            ...
            var selectColor = this.$select
                .find("option:selected")
                .data("color");

            var $markupUl = $("<ul>")
                .addClass("dropdown-menu")
                .addClass("dropdown-caret");
            var $markupDiv = $("<div>")
                .addClass("dropdown")
                .addClass("dropdown-colorselector");
            var $markupSpan = $("<span>")
                .addClass("btn-colorselector")
            ...
            this.$select.on("change", function () {
                ...
                $(this)
                    ...
                    .find("ul")
                    .find("li")
                    .find("a[data-color='" + color + "']")
                    .addClass("selected");

                $(this)
                    .next()
                    .find(".btn-colorselector")
    ...
    $.fn.colorselector = function (option) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                $this.data(
                    "colorselector",
                    (data = new ColorSelector(this, options))
                );
            }
